...
/**
 * Merges the passed scope into this scope.
 *
 * The input scope takes priority on conflicts.
 *
 * @param {Scope} scope
 * @api private
 */
Scope.prototype.merge = function(scope, parent){
  var locals = scope.locals;
  for (var name in locals) {
    this.locals[name] = locals[name].clone(parent);
  }
};
