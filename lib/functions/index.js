...
(exports['add-property'] = function addProperty(name, expr){
  ...
  block.nodes.splice(block.index++, 0, prop);
  // Need to clone the nodes array for this to work properly with expression blocks
  // TODO : See if this requirement can be removed
  block.nodes = block.nodes.slice(0);
