...
var Visitor = require('./')
  , LookupScanner = require('./lookup-scanner')
  , units = require('../units')
  , nodes = require('../nodes')
  , Stack = require('../stack')
...
var lookupScanner = new LookupScanner();
...
Evaluator.prototype.visitBinOp = function(binop){
  ...
  if (this.partialEval
      && (lookupScanner.visit(left) || lookupScanner.visit(right))) {
    // We couldn't complete evaluation right now due to an incomplete scope.
    // Leave this for the full eval.
    return binop;
  }
